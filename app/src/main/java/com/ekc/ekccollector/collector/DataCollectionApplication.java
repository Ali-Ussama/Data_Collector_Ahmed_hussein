package com.ekc.ekccollector.collector;
...
public class DataCollectionApplication extends MultiDexApplication {
    ...
    public static ThreadSingleton mThreadSingleton;

    public DataCollectionApplication getInstance() {
        return new DataCollectionApplication();
    }
...
//        GeoDatabaseUtil.gdbFileName = getFilesDir().getPath() + GeoDatabaseUtil.ROOT_GEO_DATABASE_PATH + GeoDatabaseUtil.GeoFilesCount + "/offlinedata.geodatabase";
    ...
    private void initSingleton() {
        try {
            mThreadSingleton = ThreadSingleton.getInstance();
